...
fixture `End to End`
    ...
    .page `https://ee-uat.rsdelivers.com/cart`

    .meta({author: 'James Elrick', creationDate: '12/09/2022'});

  test('Estonia Test', async t => {
    ...
    .click(Selector('span').withText('Paysera'))

    .click(Selector('#root > div > div.page-content-wrapper > div > div > div > div.purchase-component_checkout-contents__2mxx9 > div.purchase-component_checkout-info__2uonT > div.card-component-module_card-component__1NA2E.card-component-module_card-radius__2eMqM.purchase-component_payment-type-card__3TYDh.card-component-module_padding__51wm7.card-component-module_white__2avgM > div.purchase-component_payment-btn-area__31CK1 > div > div > label > span'),{offsetX: 4})
    ...
    .wait(1000)
    //type email
    .typeText('#pEmail','RPlan.BSupport@rs-components.com')
    //cont.
    .click(Selector('body > div.main > div.content-wrapper > div > div.left-content.block-shadow.unfixed > div.buyer-block > div.form.email-form-wrapper > form > input.button'))
    //select paysera account
    .click(Selector('div').withText('Paysera account'))
